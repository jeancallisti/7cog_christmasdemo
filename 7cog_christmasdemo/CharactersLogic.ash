...
enum DialogVars {
  ...
  //
  /////////////////////////////////
  "eDialog_DoorState",                      //0 for closed door, 1 for semiclosed
  "eDialog_DoorCounter",                    //0 didn't ever open, 1 has opened at least once time
  "eDialog_IceCrackOpened",                 //0 Tunnel is not open, 1 Tunnel is opened
