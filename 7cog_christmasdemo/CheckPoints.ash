enum CheckPointsEnum {
  ...
  eChckpnt_50_DEBUGtumbleweedDialogsTest, 
  
  //Specifically for DEMO
  eChckpnt_100_MainMenu, 
  eChckpnt_100_MSDOS, 
  eChckpnt_101_catacombs,
  eChckpnt_101_catacombs_withcutscene, 
  eChckpnt_101_catacombs_MonkCutscene, 
  eChckpnt_101b_tintedGlass, 
  eChckpnt_102_NorwayOutside, 
  eChckpnt_103_NorwayInside, 
  eChckpnt_103b_NorwayInside_EndCutscene, 
  eChckpnt_104_NorwayIceCave, 
  eChckpnt_105_EuropeMap, 
  eChckpnt_106_IndysClassRoom, 
  eChckpnt_107_endCredit, 
  eChckpnt_110_Journal, 
  eChckpnt_111_DemoBonuses, 
  eChckpnt_112_HatchCloseUp, 
  eChckpnt_113_NorwayOven, 
  eChckpnt_114_NorwayOutside_Night
