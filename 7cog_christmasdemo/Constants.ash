...
enum RoomsEnum
{
    ...
    eRoom_DEBUG_tumbleweedDialogsTest = 18, 
    ...
    //SPAIN
    eRoom_05_00_ = 666,
    //eRoom_05_01_CountrySide = 26, //Not valid in demo 
    ...
    //DEMO
    eRoom_100_MainMenu = 1, 
    eRoom_100_MSDOS = 17, 
    eRoom_101_Catacombs = 3, 
    eRoom_101b_TintedGlass = 4, 
    eRoom_102_NorwayOutside = 5,
    eRoom_103_NorwayInside = 6,
    eRoom_104_NorwayIceCave = 7,
    eRoom_105_EuropeMap = 8,
    eRoom_106_IndysClassRoom = 16, 
    eRoom_107_EndCredits = 10, 
    eRoom_108_DumpRoom = 9, 
    eRoom_110_Journal = 13, 
    eRoom_111_DemoBonuses = 23, 
    //eRoom_112_HatchCloseUp = 24,
    eRoom_114_NorwayOutside_Night = 25, 
    eRoom_115_LanguageSelection = 26
